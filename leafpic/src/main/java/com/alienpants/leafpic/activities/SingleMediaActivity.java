...
import com.alienpants.leafpic.SelectAlbumBuilder;
...
import com.alienpants.leafpic.data.filter.MediaFilter;
import com.alienpants.leafpic.data.provider.CPHelper;
import com.alienpants.leafpic.data.sort.MediaComparators;
import com.alienpants.leafpic.fragments.BaseMediaFragment;
import com.alienpants.leafpic.fragments.ImageFragment;
...
public class SingleMediaActivity extends SharedMediaActivity implements BaseMediaFragment.MediaTapListener {
    ...
    public static final String ACTION_OPEN_ALBUM = "com.alienpants.leafpic.intent.VIEW_ALBUM";
    public static final String ACTION_OPEN_ALBUM_LAZY = "com.alienpants.leafpic.intent.VIEW_ALBUM_LAZY";
