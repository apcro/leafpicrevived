...
import com.alienpants.leafpic.LookForMediaJob;
...
public class SplashScreen extends SharedMediaActivity {
    ...
    public final static String ACTION_OPEN_ALBUM = "com.alienpants.leafpic.OPEN_ALBUM";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.alienpants.leafpic.R.layout.activity_splash);
    ...
    public void setNavBarColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ColorPalette.getTransparentColor(
                    ContextCompat.getColor(getApplicationContext(), com.alienpants.leafpic.R.color.md_black_1000), 70));
        }
    }
    ...
    public void updateUiElements() {
        ...
        findViewById(com.alienpants.leafpic.R.id.Splah_Bg).setBackgroundColor(getBackgroundColor());
    }
}
