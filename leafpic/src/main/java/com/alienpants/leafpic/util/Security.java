...
public class Security {
    ...
    public static void authenticateUser(final ThemedActivity activity, final AuthCallBack passwordInterface) {
        ...
        final View view = activity.getLayoutInflater().inflate(com.alienpants.leafpic.R.layout.dialog_password, null);
        final TextView passwordDialogTitle = view.findViewById(com.alienpants.leafpic.R.id.password_dialog_title);
        final CardView passwordDialogCard = view.findViewById(com.alienpants.leafpic.R.id.password_dialog_card);
        final EditText editTextPassword = view.findViewById(com.alienpants.leafpic.R.id.password_edittxt);
