...
public class CardViewStyleSetting extends ThemedSetting {
    ...
    public void show() {
        ...
        rGroup.setOnCheckedChangeListener((radioGroup, i) -> {
            ...
            chkShowMediaCount.setOnCheckedChangeListener((compoundButton, b) -> v.findViewById(R.id.ll_media_count).setVisibility(b ? View.VISIBLE : View.GONE));

            v.findViewById(R.id.album_path).setVisibility(chkShowAlbumPath.isChecked() ? View.VISIBLE : View.GONE);
            chkShowAlbumPath.setOnCheckedChangeListener((compoundButton, b) -> v.findViewById(R.id.album_path).setVisibility(b ? View.VISIBLE : View.GONE));
        ...
        builder.setPositiveButton(getActivity().getString(R.string.ok_action).toUpperCase(), (dialog, which) -> {
